...
async function handleSignup(e) {
  ...
  // 3. Create patient record linked to the profile
  ...
  // 4. Refresh auth role and go to patient dashboard
  await refreshRole();
    ...
    <div className="min-h-screen flex items-center justify-center bg-bg">
      ...
      >
        <h1 className="font-display font-semibold text-xl text-ink">
          Create your PhysioTrack account
        </h1>
        ...
        <input
          ...
          className="px-3 py-2.5 rounded-lg border border-[#E4E9E8] text-sm"
          required
        />
        <input
          type="email"
